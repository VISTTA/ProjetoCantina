...
import ImgSection from "../../images/wallpaperLoja2.jpg"
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <React.Fragment>
          <MetaData title="Cantina do Emerson" />
      ...
      */}
          ...
          <h2 className="homeHeading" alt="Product Most Wanted" title="Produtos Mais Procurados">Listagem de produtos</h2>
